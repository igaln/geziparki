...
exports.data = function(req, res) {
  ...
  , format = require('util').format;
	 ...
	 var client = new Db('gezi', new Server("166.78.181.167", 27017, {}), {w: 1});
			...
			var query ;	
			if(dataType == "Fotograf") {

				query = {"entities.urls.expanded_url":/.*.jpg.*/};
						...
						for (var i = 0; i < length; i++) {
						 	 ...
						 	 if(typeof urls!='undefined'){
						 	 		...
						 	 		if(dataType == "Tweet") {
						 	 			 ...
						 	 			 var HTMLdata = '<div class="row"><div class="span1 offset1"><span class="badge badge-inverse">+18</span></div><div class="span7"><a href="' + urls.expanded_url + '">' + element.text +'</a></div></div>'
										 html.push(HTMLdata);
										...
										if( urls.expanded_url.indexOf(".jpg") !== -1 || urls.expanded_url.indexOf(".png") !== -1 || urls.expanded_url.indexOf(".jpeg") !== -1) {
											//isImage = true;
											 ...
											 var HTMLdata = '<div class="row"><div class="span1 offset1"><span class="badge badge-inverse">+18</span></div><div class="span7"><img src="' + urls.expanded_url + '"></div></div>'
    				 ...
    				 if(typeof results!=='undefined' && results!==null) {
						...
						client.close();	
						 console.log(tweetdata.length);
 						 res.render('fact', { tweetdata: tweetdata, start:end  });
				});
      		});
		 });
